                    ...
                    <View style={styles.flexColumn}>
                        ...
                        <View style={styles.flexColumnRight}>
                            <InputTextNormal
                                ...
                                maxLength={this.props.opts.form.idType.value === "KTP" ? 10 : 16}
                                placeholder={i18n('recipientIdNumber')}
                                keyboardType='numeric'
                                // autocapitalize='off'
                                value = {this.state.myNumber}
                                // onChange={this.test(JSON.stringify(this.props.opts.form.recipientIdNumber.value))}
